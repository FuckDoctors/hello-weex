...
<template>
  <div>
    <div :class="['wxc-search-bar','wxc-search-bar-'+theme]"
         ...
         v-if="mod==='default'">
      <!-- 想实现中间input自适应的样子，input加上flex:1不行，它的positon为absolute，
        所以想设置right达到自适应，但是还是不行。
        后来参考了下面的资料，在input外面包一层，让input 100%，外层使用position:absolute，以及right实现自适应。
        https://stackoverflow.com/questions/1708654/using-positionabsolute-to-set-an-inputs-width
       -->
